...
clear all;
%% 
% pathname='E:\AVECdata\Training_AudioFeatures\Training\formant_readnovel\formant_corr\';
% totaldata_t_formant_pca=[];

pathname='E:\AVECdata\Development_AudioFeatures\Development\formant_readnovel\formant_corr\' ;
...
for i=203:333
   for j=1:4
       ...
       if exist([pathname filename],'file')
           ...
           dataname2=['htk_' num2str(i) '_' num2str(j) '_cut_audio_readnovel_fmt_corr_pca'];
