...
X = [mean(S_t_formant,2) mean(S_t_formant,2).^2];
y = DepressionLabels_training;
X_dev = [mean(S_d_formant,2) mean(S_d_formant,2).^2];
y_dev = DepressionLabels_dev;

% load('S_d_formant_10.mat')
% load('S_t_formant_10.mat')
% X = [mean(S_t_formant_10,2) mean(S_t_formant_10,2).^2];
% y = DepressionLabels_training;
% X_dev = [mean(S_d_formant_10,2) mean(S_d_formant_10,2).^2];
% y_dev = DepressionLabels_dev;
