...
vgg_face_model = {
        'model_def':'/home/avec1/avec2016/caffe/models/vgg_face/VGG_FACE_deploy.prototxt',
        'model_weights':'/home/avec1/avec2016/caffe/models/vgg_face/VGG_FACE.caffemodel',
...
def extract_feature_dir(model, dir_name, feature_path):
    ...
    for idx, image_name in enumerate(image_list):
        ...
        output_features[idx] = net.blobs['fc7'].data
...
def main():
    ...
    extract_feature_dir(vgg_face_model, args.dir_name, "/home/avec1/avec2016/esc_feature/model_vggface_fc7")
